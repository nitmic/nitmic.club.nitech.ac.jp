...
{{< load-photoswipe >}}
{{< gallery >}}
    {{< figure link="map.webp" caption="地図">}}
    {{< figure link="googlemap.webp" caption="航空写真">}}
{{< /gallery >}}
<!-- prettier-ignore-end -->
...
{{< gallery >}}
{{< figure link="bushitsu1.webp" caption="部室写真１">}}
{{< figure link="bushitsu2.webp" caption="部室写真２">}}
{{< figure link="nuigurumi.webp" caption="部室に並ぶぬいぐるみ">}}
{{< /gallery >}}
