...
{{< load-photoswipe>}}
{{< gallery>}}
  {{< figure link="geek-haku1.webp" caption="SHIBUYA" >}}
  {{< figure link="geek-haku2.webp" caption="会場からの景色" >}}
  {{< figure link="geek-haku3.webp" caption="部内Scrapboxにある参加記" >}}
{{< /gallery>}}
<!-- prettier-ignore-end -->
...
{{< x user="nitmic_twi" id="1540733735137452033" >}}
